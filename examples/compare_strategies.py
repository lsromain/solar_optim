...
from solar_optimization.core import TimeSeriesConfig, BaseConsumption, ConsumptionPeak, SolarProduction, SolarProductionPeak
...
def main():
    ...
    strategies = [
        ...
        ScheduledStrategy("Day scheduling", [
